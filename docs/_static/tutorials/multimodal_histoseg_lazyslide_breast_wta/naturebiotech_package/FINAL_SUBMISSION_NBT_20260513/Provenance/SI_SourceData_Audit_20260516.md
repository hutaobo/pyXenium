...
- Supplementary Table 3 matches `Figure_1e_CrossCancer_Signature_Source_Data.csv` after rounding maximum absolute partial rho values to three decimals and retaining the breast PLIP invasion/boundary/EMT `not_detected` row.

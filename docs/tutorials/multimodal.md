...
:::{grid-item-card} Renal RNA + protein
:link: multimodal_renal_rna_protein
:link-type: doc
Load the renal FFPE RNA + protein bundle, annotate joint cell states, quantify
RNA/protein discordance, and summarize immune-resistance niches.
:::

:::{grid-item-card} RNA + contour + H&E
:link: multimodal_rna_contour_he
:link-type: doc

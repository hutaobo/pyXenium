...
- Non-recovery of a canonical axis in the common-db benchmark can reflect CCI
  resource coverage, ligand-receptor-resource filtering, or panel detectability

...
produced by :func:`pyXenium.multimodal.load_rna_protein_anndata`.
"""
...
def rna_protein_cluster_analysis(
    ...
    *,
    ...
    adata:
        ...
        :func:`pyXenium.multimodal.load_rna_protein_anndata`. Requires
        ``adata.layers['rna']`` (or ``adata.X``) and ``adata.obsm['protein']``.
    n_clusters:

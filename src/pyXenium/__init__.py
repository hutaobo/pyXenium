...
_ATTRIBUTE_EXPORTS = {
    ...
    "aggregate_morphopathway_inputs_to_spatial_blocks": (".pathway", "aggregate_morphopathway_inputs_to_spatial_blocks"),
    ...
    "build_curated_pathway_panel": (".pathway", "build_curated_pathway_panel"),
    ...
    "compute_matched_random_pathway_controls": (".pathway", "compute_matched_random_pathway_controls"),
    "compute_pathway_coverage": (".pathway", "compute_pathway_coverage"),
    "fit_residual_pathway_morphology_associations": (".pathway", "fit_residual_pathway_morphology_associations"),
    ...
    "MorphoPathwayConfig": (".pathway", "MorphoPathwayConfig"),
    "prepare_xenium_cell_morphopathway_inputs": (".pathway", "prepare_xenium_cell_morphopathway_inputs"),
    ...
    "run_atera_morphopathway_brief": (".pathway", "run_atera_morphopathway_brief"),
    "run_xenium_cell_morphopathway_smoke": (".pathway", "run_xenium_cell_morphopathway_smoke"),
    ...
    "sample_clip_image_embeddings_at_cells": (".pathway", "sample_clip_image_embeddings_at_cells"),
    "sample_he_image_features_at_cells": (".pathway", "sample_he_image_features_at_cells"),
    ...
    "summarize_cross_cancer_validation": (".pathway", "summarize_cross_cancer_validation"),

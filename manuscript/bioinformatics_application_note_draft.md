...
**Availability and implementation:** Implemented in Python. Source code: `https://github.com/hutaobo/pyXenium`. Package index: [PyPI URL placeholder if published]. Documentation: [documentation URL placeholder]. Current repository version: `0.4.5`. License: `AGPL-3.0-only`. Maintained by `SPATHO AB`.

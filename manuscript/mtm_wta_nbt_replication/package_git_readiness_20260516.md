...
The old stale source-data names should be removed from git:

- `Figure_2_Hero_Patches_Source_Data.csv`
- `Figure_3_MAZ_QC_Source_Data.csv`
- `Figure_4_CrossCancer_Signature_Source_Data.csv`
- `Supplementary_BlockBootstrap_Source_Data.csv`
- `Supplementary_Spatial_Permutation_Source_Data.csv`
...
Then run the `git add -f` command for the five renamed source-data CSVs above.
...
- five one-figure source-data CSVs

...
Run directory: `D:\GitHub\pyXenium\benchmarking\morphopathway_atera\results\plip_smoke_1500_d64_seed43_20260512_1858`
...
- Breast discovery observations: 149 spatial blocks from 1500 sampled cells.
- Cervical validation observations: 159 spatial blocks from 1500 sampled cells.
...
- Breast top association: `immune_activation` / `embedding__plip_006`, abs partial Spearman rho = 0.2672.
- Cervical top association: `basal_squamous_state` / `embedding__plip_033`, abs partial Spearman rho = 0.2425.
- Cross-cancer pathway/family recovery: 8/10.

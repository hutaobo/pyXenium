...
Run directory: `D:\GitHub\pyXenium\benchmarking\morphopathway_atera\results\he_projection_block_6k_smoke_20260512_1808`
...
- Breast H&E embedding backend status: `deterministic_patch_projection_fallback`; cervical H&E embedding backend status: `deterministic_patch_projection_fallback`.
- WTA features: curated pathway activity scores from Xenium `cell_feature_matrix.h5`.

## Key results

- Breast top association: `basal_squamous_state` / `embedding__he_patch_projection_012`, abs partial Spearman rho = 0.1519.

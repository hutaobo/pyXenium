...
Run directory: `D:\GitHub\pyXenium\benchmarking\morphopathway_atera\results\plip_smoke_1500_d64_seed29_20260512_1843`
...
- Breast discovery observations: 148 spatial blocks from 1500 sampled cells.
...
- Breast top association: `oxidative_phosphorylation` / `embedding__plip_060`, abs partial Spearman rho = 0.2410.
- Cervical top association: `unfolded_protein_response` / `embedding__plip_016`, abs partial Spearman rho = 0.2962.

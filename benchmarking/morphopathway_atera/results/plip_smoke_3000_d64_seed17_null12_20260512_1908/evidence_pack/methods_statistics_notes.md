...
Run directory: `D:\GitHub\pyXenium\benchmarking\morphopathway_atera\results\plip_smoke_3000_d64_seed17_null12_20260512_1908`
...
- Breast discovery observations: 237 spatial blocks from 3000 sampled cells.
- Cervical validation observations: 252 spatial blocks from 3000 sampled cells.
...
- Breast top association: `basal_squamous_state` / `embedding__plip_059`, abs partial Spearman rho = 0.2642.
- Cervical top association: `collagen_ecm_organization` / `embedding__plip_053`, abs partial Spearman rho = 0.2188.

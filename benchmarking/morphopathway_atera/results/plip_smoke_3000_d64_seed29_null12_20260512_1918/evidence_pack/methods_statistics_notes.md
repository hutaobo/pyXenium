...
Run directory: `D:\GitHub\pyXenium\benchmarking\morphopathway_atera\results\plip_smoke_3000_d64_seed29_null12_20260512_1918`
...
- Breast discovery observations: 229 spatial blocks from 3000 sampled cells.
- Cervical validation observations: 259 spatial blocks from 3000 sampled cells.
...
- Breast top association: `unfolded_protein_response` / `embedding__plip_013`, abs partial Spearman rho = 0.2075.
- Cervical top association: `immune_activation` / `embedding__plip_037`, abs partial Spearman rho = 0.1984.
- Cross-cancer pathway/family recovery: 0/10.

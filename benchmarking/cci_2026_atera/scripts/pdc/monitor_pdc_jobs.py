...
def main() -> None:
    parser = argparse.ArgumentParser(description="Monitor PDC CCI benchmark Slurm jobs and remote run artifacts.")
    ...
    local_root = Path(args.local_root) if args.local_root else Path.cwd() / "benchmarking" / "cci_2026_atera"

...
def main() -> None:
    ...
    layout = resolve_layout(relative_root=args.benchmark_root or Path("benchmarking") / "cci_2026_atera")
    payload = run_pyxenium_smoke(
        ...
        cci_panel_path=args.cci_panel_path or layout.data_dir / "atera_smoke_panel.tsv",

...
- PDC root: `/cfs/klemming/scratch/h/hutaobo/pyxenium_gmi_modules_2026-04-30`
...
| --- | ---: | ---: | --- |
| `smoke_contour_top200_spatial50` | 0 | 0 | - |
| `full_contour_top500_spatial100` | 1 | 30 | `gmi_module_001`: S5 (NIBAN1,SORL1) |
| `full_contour_top500_spatial100_stability` | 1 | 30 | `gmi_module_001`: S5 (NIBAN1,SORL1) |
| `validation_rna_only_qc20` | 1 | 30 | `gmi_module_001`: S5 (NIBAN1,SORL1,EFHD1) |
| `validation_spatial_only_qc20` | 2 | 46 | `gmi_module_001`: S5 (omics__whole__state_fraction__luminal_like_amorphous_dcis_cells,omics__inner_rim__state_fraction__luminal_like_amorphous_dcis_cells,omics__core__state_fraction__luminal_like_amorphous_dcis_cells)<br>`gmi_module_002`: S5 (geometry__compactness) |
| `validation_no_coordinate_qc20` | 1 | 30 | `gmi_module_001`: S5 (NIBAN1,SORL1) |
| `sensitivity_top1000_spatial100_qc20` | 1 | 30 | `gmi_module_001`: S5 (SORL1,NIBAN1,EFHD1) |
| `sensitivity_all_nonempty_top500_spatial100` | 1 | 30 | `gmi_module_001`: S1 (omics__whole__state_fraction__11q13_invasive_tumor_cells,omics__core__state_fraction__11q13_invasive_tumor_cells) |

## Biological readout

- Primary QC20 model selected: NIBAN1, SORL1
- Primary QC20 has NIBAN1/SORL1 module: True
- RNA-only retained NIBAN1/SORL1: True
- RNA-only has NIBAN1/SORL1 module: True
- No-coordinate retained NIBAN1/SORL1: True
- No-coordinate has NIBAN1/SORL1 module: True
